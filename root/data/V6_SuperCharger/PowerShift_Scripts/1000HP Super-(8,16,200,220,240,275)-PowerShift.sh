...
echo ""
sleep 1
echo -n "         ...";busybox sysctl -w vm.min_free_kbytes=40960
echo ""
sleep 1
echo $line
...
echo ""
sleep 1
sed -i 's/vm.min_free_kbytes=.*/vm.min_free_kbytes=40960;/' /system/etc/init.d/*SuperCharger* 2>/dev/null
sed -i 's/free_kbytes`" -ne .* ] /free_kbytes`" -ne 40960 ] /' /system/etc/init.d/*SuperCharger* 2>/dev/null
sed -i 's/vm.min_free_kbytes=.*/vm.min_free_kbytes=40960;/' /data/99SuperCharger.sh 2>/dev/null
sed -i 's/free_kbytes`" -ne .* ] /free_kbytes`" -ne 40960 ] /' /data/99SuperCharger.sh 2>/dev/null
